...
<body>
    <h2>Tabla</h2>
    <?php
    // Modifique el programa desarrollado en la Actividad 3 para implementarlo utilizando funciones. Desarrolle todas las funciones que considere necesarias para modularizar el programa.
