...
function renderAlert(string $type, string $message): void {
    ...
    <div class='max-w-3xl mx-auto mt-4 px-4'>
        <div class='border rounded-lg bg-yellow-400 border-yellow-500 text-grey-900 px-6 py-4 font-mono shadow-sm text-sm flex justify-between items-start' role='alert' id='alert-box'>
            <span>$message</span>
            <button 
